  ...
  const campaigns = [
    {
      ...
      icon: indiaEntryIcon,
      video: "/videos/india-entry.mp4?v=5"
    },
    {
      ...
      icon: revenueIcon,
      video: "/videos/revenue-generation.mp4?v=4"
    },
    {
      title: "SocialLift",
      ...
      icon: "podcast",
      video: "/videos/social-lift.mp4?v=4"
    },
    {
      ...
      video: "/videos/brand-building.mp4?v=3"
    },
    {
      ...
      icon: "event",
      video: "/videos/event-launch.mp4?v=6"
    },
    {
      ...
      icon: "camera",
      video: "/videos/video-production.mp4?v=3"
    }
  ];
