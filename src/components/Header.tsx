...
const Header = () => {
  ...
  return <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-40 bg-orange-50/95 backdrop-blur-md shadow-sm transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`} style={{borderBottom: '3px solid #ffffff', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)'}}>
