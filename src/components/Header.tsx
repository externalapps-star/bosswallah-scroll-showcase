...
const Header = () => {
  ...
  return <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-40 bg-orange-50/95 backdrop-blur-md border-b border-white shadow-sm transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
