    ...
    <section id="channels" className="py-4 pb-2 md:py-8 px-4 bg-background">
      <div className="max-w-7xl mx-auto px-2 md:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="relative flex md:grid md:grid-cols-3 gap-2 md:gap-8 max-w-7xl mx-auto px-6 py-2 md:p-8 overflow-x-auto md:overflow-x-visible scrollbar-hide snap-x snap-mandatory md:snap-none scroll-smooth [scroll-padding-inline:1.5rem]">
