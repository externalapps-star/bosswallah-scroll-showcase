          ...
          <Tooltip delayDuration={300}>
            <TooltipTrigger asChild>
              <Button 
                variant="cta" 
                size="lg"
                className="relative rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 h-auto text-base sm:text-lg lg:text-xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-size-200 animate-gradient-x hover:animate-none border-2 border-white/20 touch-manipulation"
                onClick={() => window.open('https://calendly.com/bosswallah', '_blank')}
              >
                <Calendar className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 animate-bounce" />
