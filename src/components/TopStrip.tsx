      ...
      <div className="flex items-center justify-between max-w-full">
        ...
        <div className="flex-1 text-center">
          <p className="text-sm md:text-base font-medium">
            <span onClick={openWhatsApp} className="bg-gradient-to-r from-[#755292] to-[#F05C25] bg-clip-text text-transparent font-bold cursor-pointer hover:opacity-80 transition-opacity">#1</span> Social Media Agency (in South India, for now)
          </p>
        </div>
