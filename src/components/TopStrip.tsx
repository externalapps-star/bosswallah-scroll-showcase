...
const TopStrip = () => {
  ...
  return <div className="fixed top-0 left-0 lg:left-40 xl:left-44 right-0 z-50 bg-[#1a1a2e] text-primary-foreground border-b border-border px-6 shadow-soft py-2">
